...
public class WebConfig implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		// 리뷰 이미지 매핑 설정
		// 맵핑 이름 : review_images
		registry.addResourceHandler("/review_images/**")
				.addResourceLocations("file:///C:/Users/Web-dev/workspaceBoot/review_images/");
	}
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		// 로그인 체크 (일반 회원용)
		registry.addInterceptor(loginCheckInterceptor).addPathPatterns("/member/myPage") // 마이페이지
